// Nitro Server Configuration for TanStack Start
// For TanStack Start, server configuration is handled via the app framework
// Redirects should be implemented in middleware or route handlers
